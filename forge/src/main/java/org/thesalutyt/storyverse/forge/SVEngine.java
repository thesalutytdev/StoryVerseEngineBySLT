...
import org.thesalutyt.storyverse.forge.api.environment.js.interpreter.Interpreter;
...
public class SVEngine {
    ...
    public static final String MOD_VERSION = "5.2-Beta";
    ...
    public static final Logger LOGGER = org.thesalutyt.storyverse.StoryVerse.LOGGER;
    ...
    public static final String MOD_SCRIPT_FILE = "mod.js";
    ...
    public static void sendInfoMessage(){
        ...
        org.thesalutyt.storyverse.StoryVerse.LOGGER.info(firstLine);
        org.thesalutyt.storyverse.StoryVerse.LOGGER.info(infoLine);
        org.thesalutyt.storyverse.StoryVerse.LOGGER.info(descLine);
        org.thesalutyt.storyverse.StoryVerse.LOGGER.info(docsLine);
        org.thesalutyt.storyverse.StoryVerse.LOGGER.info(modId);
        StoryVerse.LOGGER.info(finalLine);
    }
    public static void createEngineDirectory() {
        // ModLoadingContext.get().registerConfig(ModConfig.Type.CLIENT, SVConfig.SPEC, MOD_ID + ".toml");
