...
import org.thesalutyt.storyverse.forge.api.environment.wrapper.type.CutsceneType;
import org.thesalutyt.storyverse.forge.api.features.math.MathScript;
...
//        }
//    }
    public static InteractionHand selectHand(Integer hand) {
        switch (hand){
            case 0: {
...
//    }
    ...
    public static void use(String world, Double x, Double y, Double z) {
        ...
        if (block instanceof ButtonBlock) {
            ButtonBlock self = (ButtonBlock) block;
    ...
    public static void useDoor(String world, Double x, Double y, Double z, Boolean open) {
        ...
        if (block instanceof DoorBlock) {
            ...
            self.setOpen(mc.player, worldWrapper.getMCWorld(), state, new BlockPos(x, y, z), open);
        }
