...
public class NPCEntity extends Animal implements IAnimatable, IAnimationTickable {
    private int ticks = 0;
    ...
    private static final net.minecraft.network.syncher.EntityDataAccessor<Boolean> SLEEP =
            new net.minecraft.network.syncher.EntityDataAccessor<Boolean>(NPCEntity.class.getModifiers(),
                    EntityDataSerializers.BOOLEAN);;

    private static final net.minecraft.network.syncher.EntityDataAccessor<String> ANIMATION =
            new net.minecraft.network.syncher.EntityDataAccessor<String>(NPCEntity.class.getModifiers(),
                    EntityDataSerializers.STRING);;

    private static final net.minecraft.network.syncher.EntityDataAccessor<String> LOOP_ANIM =
            new net.minecraft.network.syncher.EntityDataAccessor<String>(NPCEntity.class.getModifiers(),
                    EntityDataSerializers.STRING);;

    private static final net.minecraft.network.syncher.EntityDataAccessor<String> ONCE_ANIM =
            new net.minecraft.network.syncher.EntityDataAccessor<String>(NPCEntity.class.getModifiers(),
                    EntityDataSerializers.STRING);;
    ...
    private static final net.minecraft.network.syncher.EntityDataAccessor<String> EMOTION =
            new net.minecraft.network.syncher.EntityDataAccessor<String>(NPCEntity.class.getModifiers(),
                    EntityDataSerializers.STRING);

    private static final net.minecraft.network.syncher.EntityDataAccessor<String> TEXTURE =
            new net.minecraft.network.syncher.EntityDataAccessor<String>(NPCEntity.class.getModifiers(),
                    EntityDataSerializers.STRING);

    private static final net.minecraft.network.syncher.EntityDataAccessor<String> MODEL =
            new net.minecraft.network.syncher.EntityDataAccessor<String>(NPCEntity.class.getModifiers(),
                    EntityDataSerializers.STRING);

    private static final net.minecraft.network.syncher.EntityDataAccessor<String> ANIMATION_FILE =
            new net.minecraft.network.syncher.EntityDataAccessor<String>(NPCEntity.class.getModifiers(),
                    EntityDataSerializers.STRING);
    private static final net.minecraft.network.syncher.EntityDataAccessor<Boolean> MOVE =
            new net.minecraft.network.syncher.EntityDataAccessor<Boolean>(NPCEntity.class.getModifiers(),
                    EntityDataSerializers.BOOLEAN);
    ...
    public NPCEntity(EntityType<? extends Animal> p_i48568_1_, Level p_i48568_2_) {
    ...
    public void tick() {
        ...
        if (focusedEntity != null) {
            lookAt(
                    ...
                    new Vector3d(focusedEntity.getX(),
...
//        if (GroundPathNavigator.hasGroundPathNavigation(this)) {
...
//    }
    ...
    @Override
    public AgeableMob getBreedOffspring(ServerLevel arg, AgeableMob arg2) {
        return null;
    }
...
//    @Nullable
//    @Override
//    public NPCEntity getBreedOffspring(ServerLevel serverWorld, AgeableMob ageableEntity) {
//        return null;
//    }
    ...
    @Override
    public void setDropChance(EquipmentSlot slotType, float chance) {
...
//
    ...
    public void hold(InteractionHand hand, ItemStack item) {
    ...
    public void lookAt(EntityAnchorArgument.Anchor anchor, Vector3d vector3d) {
