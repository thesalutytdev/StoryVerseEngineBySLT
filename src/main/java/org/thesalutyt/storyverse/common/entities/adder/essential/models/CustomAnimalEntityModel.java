...
public class CustomAnimalEntityModel extends AnimatedGeoModel<CustomAnimalEntity> {
    ...
    @Override
    public ResourceLocation getModelLocation(CustomAnimalEntity object) {
    ...
    @Override
    public ResourceLocation getTextureLocation(CustomAnimalEntity object) {
        String path = object.getTexturePath();
        return parsePathTexture(path == "" ? "storyverse:textures/entity/npc" : path.toLowerCase());
    }

    @Override
    public ResourceLocation getAnimationFileLocation(CustomAnimalEntity animatable) {
    ...
    @Override
    public void setCustomAnimations(CustomAnimalEntity animatable, int instanceId, AnimationEvent animationEvent) {
        try {
