...
public class CustomFlyingEntityModel extends AnimatedGeoModel<CustomFlyingEntity> {
    ...
    @Override
    public ResourceLocation getModelLocation(CustomFlyingEntity object) {
    ...
    @Override
    public ResourceLocation getTextureLocation(CustomFlyingEntity object) {
        String path = object.getTexturePath();
        return parsePathTexture(path == "" ? "storyverse:textures/entity/npc" : path.toLowerCase());
    }

    @Override
    public ResourceLocation getAnimationFileLocation(CustomFlyingEntity animatable) {
    ...
    @Override
    public void setCustomAnimations(CustomFlyingEntity animatable, int instanceId, AnimationEvent animationEvent) {
        try {
