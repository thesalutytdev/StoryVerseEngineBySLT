...
public class CustomFlyingEntity extends FlyingEntity implements IAnimationTickable, IAnimatable {
    public String id;
    ...
    private static final DataParameter<Boolean> SLEEP =
            EntityDataManager.defineId(CustomFlyingEntity.class, DataSerializers.BOOLEAN);

    private static final DataParameter<String> ANIMATION =
            EntityDataManager.defineId(CustomFlyingEntity.class, DataSerializers.STRING);
    ...
    public CustomFlyingEntity(EntityType<? extends FlyingEntity> entity, World level) {
        super(entity, level);
    }
